...
summary(assignment_3_dataset$STAI_trait)
...
ggplot(assignment_3_dataset, aes(weight)) +
  geom_boxplot()

ggplot(assignment_3_dataset, aes(IQ)) +
  geom_histogram()

ggplot(assignment_3_dataset, aes(household_income)) +
  geom_boxplot()

assignment_3_dataset %>%
  count(sex)

ggplot(assignment_3_dataset, aes(pain, STAI_trait)) +
  geom_point()

ggplot(assignment_3_dataset, aes(pain, pain_cat)) +
  geom_point()

ggplot(assignment_3_dataset, aes(pain, cortisol_serum)) +
  geom_point()

ggplot(assignment_3_dataset, aes(pain, cortisol_saliva)) +
  geom_point()

ggplot(assignment_3_dataset, aes(pain, mindfulness)) +
  geom_point()
...
```{r}
pain_df <- assignment_3_dataset %>%
  str_replace(sex, "woman", "female")
...
```{r}
model_c <- lm(pain ~ age + sex + STAI_trait + pain_cat + cortisol_serum + cortisol_saliva + mindfulness, data = assignment_3_dataset)
glance(model_c)
summary(model_c)
